...
<html style="font-size: 16px;">
  <head>
    ...
    <title>tip_write</title>
    <link rel="stylesheet" href="css/nicepage.css" media="screen">
<link rel="stylesheet" href="css/tip_write.css" media="screen">
    ...
    <meta property="og:title" content="tip_write">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-c967"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-image u-section-1" src="" id="sec-8373" data-image-width="1280" data-image-height="542">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-body-alt-color u-text-1">WRITE</h2>
        <p class="u-text u-text-body-alt-color u-text-default u-text-2">Home &gt; Tip &gt; Write</p>
      </div>
    </section>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="https://nicepage.com/editor/Forms/Process" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
            ...
            <input type="hidden" id="pageId" name="pageId" value="622256">
            ...
            <div class="u-form-group u-form-message u-form-textarea u-form-group-2">
              ...
              <textarea rows="20" cols="50" id="textarea-5f9c" name="textarea-1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required"></textarea>
            </div>
            <div class="u-align-center u-form-group u-form-submit">
              <a href="#" class="u-border-2 u-border-hover-palette-3-base u-btn u-btn-round u-btn-submit u-button-style u-hover-white u-palette-3-light-1 u-radius-20 u-text-body-alt-color u-text-hover-palette-3-base u-btn-1">등록</a>
        ...
        <h4 class="u-text u-text-default u-text-2">제<span style="font-weight: 700;"></span>목
        </h4>
      </div>
    </section>
